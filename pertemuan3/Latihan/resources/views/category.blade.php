<x-layout title="List Kategori">
    <h1 class="text-4xl font-bold text-gray-800 mb-8">List Kategori</h1>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($categories as $category)
            <div class="bg-gradient-to-br from-red-500 to-orange-600 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
